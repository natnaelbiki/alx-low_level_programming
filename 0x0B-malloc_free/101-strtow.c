#include "main.h"
/**
 * isSpace - check if char is space or not
 * @c: input char
...
/**
 * startIndex - returns the first index of non-space char
 * @s: input string
...
/**
 * endIndex - returns the last index of non-space char
 * @s: input string
 * @index: ending index
 * Return: index of last char
 */
